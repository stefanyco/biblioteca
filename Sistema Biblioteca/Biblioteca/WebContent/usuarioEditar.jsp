				...
				<form action="usuario?acao=atualizar" class="form-horizontal" method="post">
					...
					<div class="form-group">
						...
						<div class="col-xs-2">
							...
							<div class="form-group">
						<label for="id" class="col-xs-2 control-label">Tipo Usuário:</label>
						<div class="col-xs-2">
							<input value="<%=usuario.getTpUsuario()%>" type="text"
								class="form-control" name="tipoUsuario" required readonly="true"
								maxlength="20">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-2">
							<input value="<%=usuario.getSenha()%>"type="password" class="form-control" name="senha" required maxlength="50">
						</div>
					</div>
					<div class="form-group">
